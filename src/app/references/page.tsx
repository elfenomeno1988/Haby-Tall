          ...
          <ScrollReveal>
            <div className="max-w-4xl">
              ...
              <h1 className="mt-4 font-heading text-[clamp(2.8rem,5.5vw,5rem)] font-semibold leading-[1.06]">
                ...
                <br />des marques{" "}
                <span className="font-normal italic text-brand-gray">transformées.</span>
              </h1>
              ...
              {[
                ...
                <StaggerItem key={col.label}>
                  <div className="border-l-[3px] border-brand-green/10 pl-6">
                    ...
                    <p className="mt-4 text-[15px] leading-[1.8] text-brand-gray">{col.content}</p>
                  </div>
                </StaggerItem>
              ))}
              <StaggerItem>
            ...
            <ScrollReveal>
              <div>
                ...
                <h2 className="font-heading text-[clamp(2.4rem,4.5vw,3.8rem)] font-semibold text-brand-offwhite leading-[1.08]">
                  ...
                  <span className="font-normal italic text-brand-offwhite/40">être la prochaine.</span>
                </h2>
              </div>
            </ScrollReveal>
            <ScrollReveal delay={0.1}>
              <div className="lg:pl-16 lg:border-l lg:border-brand-offwhite/10">
                <p className="text-[18px] leading-[1.8] text-brand-offwhite/50">Discutons de votre enjeu lors d&apos;une session de cadrage.</p>
